...
if __name__ == '__main__':
    cli = argparse.ArgumentParser(description='Valide la structure du fichier json de solution')
    cli.add_argument('solution_file', help='Fichier au format json contenant la solution', type=str, nargs='+')
    args = cli.parse_args()
    # '../data/solution_template.json'
    for f in args.solution_file:
        validate_solution_file_format(f) 
